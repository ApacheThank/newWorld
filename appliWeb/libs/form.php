...
class Form {
        ...
        public function __construct($uniqid, $method = 'get') {
                ...
                if (false !== $uniqid && in_array($uniqid, self::$instances)) {
                        ...
                        trigger_error("Un formulaire identifi&eacute; par '$uniqid' existe d&eacute;j&agrave; ! Conflits potentiels d&eacute;tect&eacute;s !", E_USER_WARNING);
        ...
        public function add($field, $name) {
                ...
                if (!isset($this->fields[$name])) {
                        ...
                        trigger_error("Un champ nomm&eacute; '$name' existe d&eacute;j&agrave; dans le formulaire identifi&eacute; par '{$this->uniqid}'.", E_USER_WARNING);
                }
        }
...
abstract class Form_Field {
        ...
        protected function _init() {
                ...
                if (!isset(self::$error_list['maxlength'])) {
                        ...
                        self::$error_list['maxlength'] = 'La longueur maximale est de %d caract&egrave;res.';
                }
        }
        ...
        public function custom_error_message($id_error, $message) {
                ...
                if (!isset(self::$error_list[$id_error])) {
                        ...
                        trigger_error("Le message d'erreur identifi&eacute; par '$id_error' ne s'applique pas &agrave; la classe ".get_class($this).".");
...
class Form_Date extends Form_Text {
        ...
        protected function _init() {
                ...
                if (!isset(self::$error_list['invalid_date'])) {
                        ...
                        self::$error_list['invalid_date'] = "La date entr&eacute;e n'existe pas.";
                }
                if (!isset(self::$error_list['invalid_date_format'])) {

                        self::$error_list['invalid_date_format'] = "La date entr&eacute;e ne respecte pas le format impos&eacute; (%s).";
                }
        }
...
class Form_File extends Form_Input {
        ...
        protected function _init() {
                ...
                if (!isset(self::$error_list['invalid_file_extension'])) {
                        ...
                        self::$error_list['invalid_file_extension'] = "Cette extension est interdite ! (sont autoris&eacute;es : %s).";
                }
